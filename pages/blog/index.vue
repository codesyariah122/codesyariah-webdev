<template>
	<section class="wrapper mt-5">
		<div class="container">
			...
			<div class="row">
				<div v-for="post in allposts" class="col-sm-12 col-md-6 col-lg-4 mb-4"><div class="card text-white card-has-bg click-col" style="background-image:url('https://source.unsplash.com/600x900/?tech,street');">
