    ...
    <section class="builder-hero">
      <div class="builder-container">
        <div class="builder-hero-copy">
          ...
          <p>
            Pilih jenis bisnis, gaya visual, halaman, dan fitur yang dibutuhkan.
            Preview di samping akan berubah otomatis supaya calon client bisa
            membayangkan arah website yang akan dibuat Codesyariah Webdev.
          </p>
    ...
    <section id="builder-workspace" class="builder-workspace">
      <div class="builder-container">
        <div class="builder-heading">
          ...
          <p>
            Ini bukan final design, tapi simulasi arah struktur, prioritas
            konten, dan fitur agar diskusi awal lebih jelas walaupun belum
            familiar dengan istilah teknis.
          </p>
        </div>
        ...
        <div class="builder-grid">
          <aside class="builder-controls" aria-label="Pengaturan website">
            ...
            <div class="control-group">
              ...
              <input
                ...
                type="text"
                placeholder="Contoh: Al Mubarok Furniture"
              />
            </div>
            ...
            <div class="control-group">
              ...
              <input
                id="mainOffer"
                v-model="form.mainOffer"
                type="text"
                :placeholder="selectedBusiness.offer"
              />
            </div>
          ...
          <section class="builder-preview-area" aria-label="Preview website">
            ...
            <div
              class="preview-shell"
              :class="[previewMode, activeStyle.id]"
              :style="previewCssVars"
            >
              <div
                v-if="isDashboardPreview"
                class="mock-website dashboard-mock"
              >
              ...
              <div v-else class="mock-website">
                <header class="mock-nav">
                  ...
                  <nav :class="{ open: mockMenuOpen }">
                    <span
                      v-for="item in previewPages.slice(0, 4)"
                      :key="item"
                      >{{ item }}</span
                    >
                  </nav>
                  <button
                    ...
                    :aria-label="
                      mockMenuOpen ? 'Tutup menu preview' : 'Buka menu preview'
                    "
                ...
                <section class="mock-feature-strip">
                  <span
                    v-for="feature in previewFeatures.slice(0, 4)"
                    :key="feature"
                  >
                ...
                <section class="mock-about-section">
                  <div>
                    ...
                    <h4>
                      {{ previewBrand }} dibuat untuk customer yang ingin
                ...
                <section
                  ...
                  class="mock-content-section alt"
                >
                  <div class="mock-section-heading">
                    <span class="mock-section-label">{{
                      selectedBusiness.catalogLabel
                    }}</span>
                ...
                <section
                  v-if="previewPages.includes('Testimoni')"
                  class="mock-testimonial-section"
                >
                  <div>
                    <span class="mock-section-label">Testimoni</span>
                    <h4>
                      Calon customer melihat bukti bahwa bisnis Anda bisa
                      dipercaya.
                    </h4>
                  </div>
                  <blockquote>
                    "Informasinya jelas, mudah dipahami, dan kami jadi lebih
                    cepat menghubungi tim {{ previewBrand }}."
                  </blockquote>
                </section>

                <section
                  v-if="previewPages.includes('Blog')"
                  class="mock-content-section"
                >
                  <div class="mock-section-heading">
                    <span class="mock-section-label">Insight / Blog</span>
                    <h4>
                      Konten edukasi untuk bantu SEO dan menjawab pertanyaan
                      customer.
                    </h4>
                  </div>
                ...
                <section class="mock-pricing-section">
                  <div class="mock-section-heading">
                    ...
                    <h4>
                      Area yang membantu visitor paham langkah berikutnya.
                    </h4>
                  </div>
                ...
                <section class="mock-contact-section">
                  <div>
                    ...
                    <p>
                      Visitor bisa langsung menghubungi via WhatsApp, mengisi
                      form, atau melihat lokasi bisnis.
                    </p>
                  </div>
                  <div class="mock-contact-card">
                    <span v-if="previewFeatures.includes('WhatsApp CTA')"
                      ><i class="bx bxl-whatsapp"></i> WhatsApp CTA aktif</span
                    >
                    <span v-if="previewFeatures.includes('Form Konsultasi')"
                      ><i class="bx bx-message-square-detail"></i> Form
                      konsultasi</span
                    >
                ...
                <footer class="mock-footer">
                  ...
                  <span
                    ...
                    {{ packageRecommendation.name }}</span
                  >
                </footer>
              </div>
            </div>
        ...
        <div class="builder-summary">
          ...
          <div class="summary-block">
            ...
            <p>
              {{ form.pages.length }} halaman, {{ form.features.length }} fitur
              prioritas.
            </p>
          </div>
        ...
        <section
          class="builder-license"
          aria-labelledby="builder-license-title"
        >
          <div>
            <span>License & Ownership Notice</span>
            <h2 id="builder-license-title">
              Website Builder Preview adalah karya original Codesyariah Webdev.
            </h2>
            <p>
              Konsep implementasi, source code, UI/UX, copywriting, struktur
              preview, dan materi visual pada fitur ini dibuat dan dikembangkan
              oleh Puji Ermanto selaku engineer / developer Codesyariah Webdev.
              Dilarang menyalin, mendistribusikan ulang, menjual ulang, atau
              membuat turunan komersial dari fitur ini tanpa izin tertulis.
            </p>
          </div>
          <div class="builder-license-card">
            ...
            <a
              href="/WEBSITE-BUILDER-LICENSE.txt"
              target="_blank"
              rel="noreferrer"
            >
...
export default {
      ...
      businessTypes: [
        {
          ...
          headline:
            "Bangun company profile yang membuat bisnis terlihat siap dipercaya.",
          subcopy:
            "Struktur halaman dibuat agar calon customer cepat paham layanan, bukti kerja, dan cara menghubungi tim Anda.",
          about:
            "Bagian ini menjelaskan siapa bisnis Anda, masalah customer yang diselesaikan, dan alasan kenapa calon customer aman untuk mulai bertanya.",
          catalogLabel: "Portfolio",
          catalogTitle:
            "Contoh project atau dokumentasi pekerjaan yang bisa memperkuat kepercayaan.",
        ...
        },
        {
          ...
          headline:
            "Ubah traffic iklan menjadi lead dengan halaman promosi yang fokus.",
          subcopy:
            "Konten, benefit, bukti sosial, dan CTA disusun agar visitor tidak bingung mengambil langkah berikutnya.",
          about:
            "Landing page menonjolkan problem, benefit, bukti, dan CTA agar visitor dari iklan tidak kehilangan konteks saat masuk halaman.",
          catalogLabel: "Campaign Highlights",
          catalogTitle:
            "Bagian visual untuk menampilkan benefit, bonus, atau alasan visitor harus action sekarang.",
          icon: "bx bx-rocket",
          metric: "1 CTA",
        ...
        },
        {
          ...
          headline:
            "Tampilkan produk dengan rapi tanpa membuat customer harus tanya satu per satu.",
          subcopy:
            "Cocok untuk toko, supplier, jasa, dan brand yang butuh katalog online dengan tombol order cepat.",
          about:
            "Katalog membantu customer melihat kategori, detail produk, harga awal, dan cara order tanpa harus scroll chat panjang.",
          catalogLabel: "Produk Unggulan",
          catalogTitle:
            "Grid produk yang rapi untuk membantu customer memilih sebelum menghubungi admin.",
          icon: "bx bx-store",
          metric: "100+",
        ...
        },
        {
          ...
          offer:
            "Website sales mobile untuk tim lapangan, reseller, atau sales canvassing",
          headline: "Bantu sales menjelaskan produk lebih cepat dari HP.",
          subcopy:
            "Cocok untuk sales lapangan yang butuh katalog ringkas, script penawaran, tombol WhatsApp, dan form lead sederhana saat bertemu calon customer.",
          about:
            "Website sales mobile dibuat ringan, cepat dibuka, dan fokus membantu sales menjelaskan value produk tanpa membawa brosur fisik terlalu banyak.",
          catalogLabel: "Sales Kit",
          catalogTitle:
            "Materi penjualan mobile yang bisa dibuka cepat saat follow up calon customer.",
        ...
        },
        {
          ...
          badge: "Trip Booking",
          offer:
            "Website tour travel dengan pemesanan paket langsung via WhatsApp",
          headline:
            "Tampilkan paket wisata rapi, lalu arahkan booking ke WhatsApp.",
          subcopy:
            "Paket trip, itinerary, fasilitas, harga mulai, jadwal keberangkatan, dan tombol tanya admin dibuat jelas agar customer mudah booking tanpa checkout rumit.",
          about:
            "Website tour travel WhatsApp cocok untuk agen perjalanan yang ingin menampilkan paket secara profesional, tapi tetap menerima order lewat chat admin.",
          catalogLabel: "Paket Tour",
          catalogTitle:
            "Preview paket wisata lengkap dengan highlight destinasi, durasi, dan CTA tanya jadwal.",
          icon: "bx bx-map-alt",
          metric: "WA",
        ...
        },
        {
          ...
          headline:
            "Rapikan proses manual menjadi dashboard yang lebih mudah dipantau.",
          subcopy:
            "Data customer, order, laporan, user role, dan workflow internal bisa dibuat bertahap sesuai prioritas bisnis.",
          about:
            "Web app atau dashboard fokus pada data, proses, dan akses user supaya operasional tidak bergantung pada catatan manual.",
          catalogLabel: "Dashboard Modules",
          catalogTitle:
            "Preview modul admin untuk melihat data penting, status, dan aktivitas bisnis.",
          icon: "bx bx-data",
          metric: "Role",
      ...
      colorPalettes: [
        {
          id: "emerald",
          title: "Emerald",
          swatch: "linear-gradient(135deg, #18d19b, #0f766e)",
          primary: "#18d19b",
          dark: "#082027",
          soft: "#d9fff1",
        },
        ...
        },
        {
          id: "rose",
          title: "Rose",
          swatch: "linear-gradient(135deg, #fb7185, #be123c)",
          primary: "#fb7185",
          dark: "#35151d",
          soft: "#ffe4e6",
        },
        {
          id: "gold",
          title: "Gold",
          swatch: "linear-gradient(135deg, #facc15, #b45309)",
          primary: "#facc15",
          dark: "#2f2410",
          soft: "#fef3c7",
        },
  ...
  computed: {
    ...
    whatsappLink() {
      return `https://wa.me/${this.whatsappPhone}?text=${encodeURIComponent(
        "Halo Codesyariah, saya ingin mencoba Website Builder Preview."
      )}`;
    },
    selectedBusiness() {
      return (
        this.businessTypes.find((item) => item.id === this.form.businessType) ||
        this.businessTypes[0]
      );
    },
    activeStyle() {
      return (
        this.visualStyles.find((item) => item.id === this.form.visualStyle) ||
        this.visualStyles[0]
      );
    },
    activePalette() {
      return (
        this.colorPalettes.find((item) => item.id === this.form.colorPalette) ||
    ...
    previewFeatures() {
      return this.form.features.length
        ? this.form.features
        : ["WhatsApp CTA", "Responsive Design"];
    },
    isDashboardPreview() {
      ...
      return [
        {
          ...
          status: "In review",
          amount: "Rp 18,5jt",
          statusClass: "bx bx-time-five warning",
        },
        {
          client: "Grandia Hotel",
          module: "Booking",
          status: "Running",
          amount: "Rp 42jt",
          statusClass: "bx bx-check-circle success",
        },
        {
          client: "Alazhar School",
          module: "Admission",
          status: "Deploy",
          amount: "Rp 27jt",
          statusClass: "bx bx-cloud-upload info",
        },
        {
          client: "Retail Store",
          module: "Inventory",
          status: "Pending",
          amount: "Rp 9,8jt",
          statusClass: "bx bx-error-circle danger",
        },
      ];
    },
    dashboardModules() {
      return [
        {
          ...
          title: "Master Data",
          description:
            "Customer, produk, supplier, cabang, dan kategori dibuat terpusat.",
        },
        {
          icon: "bx bx-transfer-alt",
          title: "Workflow Approval",
          description:
            "Alur request, validasi, revisi, dan approval bisa dipantau.",
        },
        {
          icon: "bx bx-shield-quarter",
          title: "Role Permission",
          description: "Owner, admin, finance, dan staff punya akses berbeda.",
        },
        {
          icon: "bx bx-line-chart",
          title: "Report Export",
          description:
            "Ringkasan performa bisa diekspor untuk evaluasi bisnis.",
        },
      ];
    },
    previewSections() {
      return [
        ...
        },
        {
          ...
          description: `${this.previewPages
            .slice(0, 3)
            .join(", ")} dibuat jelas untuk alur visitor.`,
        },
        {
          icon: "bx bx-target-lock",
          title: "CTA prioritas",
          description: this.previewFeatures.includes("WhatsApp CTA")
            ? "Visitor diarahkan ke konsultasi WhatsApp."
            : "CTA bisa disesuaikan dengan target bisnis.",
        },
      ];
    },
    mockStats() {
      return [
        {
          value: this.selectedBusiness.metric,
          label: this.selectedBusiness.metricLabel,
        },
        ...
        company: [
          {
            ...
            title: "Profil bisnis",
            description:
              "Menjelaskan perusahaan, layanan, legalitas, dan value utama.",
          },
          {
            icon: "bx bx-briefcase",
            title: "Portfolio",
            description:
              "Menampilkan bukti pekerjaan atau dokumentasi aktivitas.",
          },
          {
            icon: "bx bx-phone-call",
            title: "Lead contact",
            description:
              "CTA WhatsApp dan form agar visitor mudah menghubungi.",
          },
        ],
        landing: [
          {
            icon: "bx bx-target-lock",
            title: "Offer fokus",
            description: "Headline, benefit, dan CTA disusun untuk campaign.",
          },
          {
            icon: "bx bx-bar-chart-alt-2",
            title: "Conversion flow",
            description: "Section dibuat mengikuti alur keputusan visitor.",
          },
          {
            icon: "bx bx-badge-check",
            title: "Trust proof",
            description: "Testimoni, bonus, garansi, atau bukti sosial.",
          },
        ],
        catalog: [
          {
            ...
            description:
              "Produk dikelompokkan supaya customer cepat menemukan pilihan.",
          },
          {
            icon: "bx bx-cart",
            title: "Order CTA",
            description: "Tombol order diarahkan ke WhatsApp atau checkout.",
          },
          {
            icon: "bx bx-filter-alt",
            title: "Detail item",
            description:
              "Harga, variasi, stok, atau informasi penting tampil jelas.",
          },
        ],
        "mobile-sales": [
          {
            icon: "bx bx-mobile-alt",
            title: "Sales kit mobile",
            description:
              "Materi produk, benefit, dan FAQ bisa dibuka cepat dari HP sales.",
          },
          {
            icon: "bx bx-user-plus",
            title: "Lead capture",
            description:
              "Data prospek bisa dicatat dari form sederhana atau diarahkan ke WhatsApp.",
          },
          {
            icon: "bx bx-conversation",
            title: "Follow up script",
            description:
              "CTA dan pesan WhatsApp dibuat siap kirim untuk mempercepat closing.",
          },
        ],
        travel: [
          {
            icon: "bx bx-map-pin",
            title: "Paket destinasi",
            description:
              "Trip dikelompokkan berdasarkan kota, durasi, harga, atau tipe perjalanan.",
          },
          {
            icon: "bx bx-calendar-check",
            title: "Jadwal trip",
            description:
              "Tanggal keberangkatan, kuota, dan fasilitas dibuat mudah dipahami.",
          },
          {
            icon: "bx bxl-whatsapp",
            title: "Booking WhatsApp",
            description:
              "Customer langsung tanya jadwal atau booking paket via admin WhatsApp.",
          },
        ],
        system: [
          {
            ...
            title: "User role",
            description: "Akses admin, staff, dan owner bisa dibedakan.",
          },
          {
            icon: "bx bx-data",
            title: "Database",
            description:
              "Data customer, order, atau laporan tersimpan lebih rapi.",
          },
          {
            icon: "bx bx-line-chart",
            title: "Dashboard",
            description:
              "Ringkasan status bisnis dapat dipantau dari satu tempat.",
          },
        ],
      };
        ...
        company: [
          {
            icon: "bx bx-buildings",
            title: "Company profile",
            caption: "Tentang, layanan, portfolio",
          },
          {
            icon: "bx bx-image",
            title: "Gallery activity",
            caption: "Dokumentasi dan kredibilitas",
          },
          {
            icon: "bx bx-message-square-check",
            title: "Inquiry page",
            caption: "CTA dan kontak cepat",
          },
        ],
        landing: [
          {
            icon: "bx bx-gift",
            title: "Promo benefit",
            caption: "Alasan visitor action",
          },
          {
            icon: "bx bx-timer",
            title: "Campaign urgency",
            caption: "Periode dan bonus",
          },
          {
            icon: "bx bx-like",
            title: "Social proof",
            caption: "Review dan bukti",
          },
        ],
        catalog: [
          {
            icon: "bx bx-package",
            title: "Produk utama",
            caption: "Foto, harga, detail",
          },
          {
            icon: "bx bx-purchase-tag",
            title: "Paket bundling",
            caption: "Promo dan rekomendasi",
          },
          {
            icon: "bx bx-support",
            title: "Order assist",
            caption: "Tanya admin cepat",
          },
        ],
        "mobile-sales": [
          {
            icon: "bx bx-id-card",
            title: "Profil sales",
            caption: "Nama, area, kontak cepat",
          },
          {
            icon: "bx bx-carousel",
            title: "Produk pitch",
            caption: "Benefit dan materi demo",
          },
          {
            icon: "bx bx-message-rounded-check",
            title: "Lead follow up",
            caption: "Pesan WA siap kirim",
          },
        ],
        travel: [
          {
            ...
            title: "Open trip",
            caption: "Destinasi dan itinerary",
          },
          {
            icon: "bx bx-hotel",
            title: "Fasilitas paket",
            caption: "Hotel, transport, guide",
          },
          {
            icon: "bx bxl-whatsapp",
            title: "Tanya jadwal",
            caption: "Booking via WhatsApp",
          },
        ],
        system: [
          {
            ...
            caption: "Status dan ringkasan",
          },
          {
            icon: "bx bx-table",
            title: "Data management",
            caption: "CRUD dan filter",
          },
          {
            icon: "bx bx-lock-alt",
            title: "Access control",
            caption: "Role dan permission",
          },
        ],
      };
      ...
      return [
        {
          name: "Starter",
          price: "Basic",
          description: "Cocok untuk validasi awal dan halaman inti.",
          featured: false,
        },
        {
          name: this.packageRecommendation.name,
          price: "Recommended",
          description: this.packageRecommendation.description,
          featured: true,
        },
        {
          name: "Scale",
          price: "Custom",
          description: "Untuk fitur lanjutan, integrasi, atau dashboard.",
          featured: false,
        },
      ];
    },
    shouldShowCatalog() {
      return (
        this.previewPages.includes("Portfolio") ||
        this.previewPages.includes("Produk") ||
        this.form.businessType !== "company"
      );
    },
    complexityScore() {
    ...
    packageRecommendation() {
      if (
        this.form.businessType === "system" ||
        this.form.features.includes("Dashboard Admin") ||
        this.form.features.includes("Payment Gateway")
      ) {
        return {
          name: "Custom Web App",
          description:
            "Cocok untuk kebutuhan dashboard, integrasi, database, dan workflow internal.",
        };
      }
      ...
      if (this.form.businessType === "mobile-sales") {
        return {
          ...
          description:
            "Cocok untuk sales lapangan, katalog mobile, lead capture, dan follow up WhatsApp.",
        };
      }
      ...
      if (this.form.businessType === "travel") {
        return {
          ...
          description:
            "Cocok untuk paket tour, itinerary, jadwal trip, dan order langsung via WhatsApp admin.",
        };
      }
      ...
      if (this.complexityScore >= 9) {
        return {
          ...
          description:
            "Cocok untuk website bisnis dengan banyak halaman, portfolio, blog, dan form konsultasi.",
        };
      }
      ...
      return {
        ...
        description:
          "Cocok untuk validasi awal brand, company profile ringan, atau landing promosi.",
      };
    },
    currentYear() {
  ...
  methods: {
    sendBrief() {
      ...
      window.open(
        `https://wa.me/${this.whatsappPhone}?text=${encodeURIComponent(
          message
        )}`,
        "_blank",
        "noopener"
...
.preview-shell {
  ...
  height: 720px;
  padding: 18px;
  background: linear-gradient(135deg, #e7f4f2, #f8fcfc);
}
...
.mock-contact-section {
  ...
  gap: 18px;
  align-items: center;
  background: linear-gradient(135deg, var(--builder-soft), #ffffff);
}
...
.dashboard-sidebar {
  ...
  min-height: 100%;
  padding: 18px 14px;
  background: linear-gradient(180deg, var(--builder-dark), #07171d);
  color: #ffffff;
}
...
.dashboard-chart {
  ...
  padding: 14px;
  border-radius: 8px;
  background: linear-gradient(rgba(16, 45, 53, 0.06) 1px, transparent 1px) 0 0 /
      100% 25%,
    #f7fbfb;
}
...
.preview-shell.friendly .mock-nav strong::before {
  ...
  height: 36px;
  border-radius: 999px;
  background: linear-gradient(180deg, var(--builder-primary), #f59e0b);
...
.preview-shell.friendly .mock-hero p,
.preview-shell.friendly .mock-about-section p,
...
.preview-shell.friendly .mock-about-section,
.preview-shell.friendly .mock-content-section,
.preview-shell.friendly .mock-service-grid article,
.preview-shell.friendly .mock-portfolio-grid article,
...
.preview-shell.friendly .mock-service-grid i,
.preview-shell.friendly .mock-contact-card i {
  display: inline-grid;
  place-items: center;
  width: 36px;
  height: 36px;
...
.preview-shell.friendly .mock-contact-section {
  border-radius: 8px;
  background: linear-gradient(135deg, #14353c, #0f766e);
  color: #ffffff;
}

.preview-shell.friendly .mock-contact-section h4,
.preview-shell.friendly .mock-contact-section p {
  color: #ffffff;
}
