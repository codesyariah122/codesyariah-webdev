...
import "assets/marker/store-icon.png";
import "assets/marker/store-icon.png";
...
Icon.Default.mergeOptions({
  ...
  iconRetinaUrl: require('assets/marker/store-icon.png'),
  iconUrl: require('assets/marker/store-icon.png'),
  shadowUrl: require('assets/marker/store-icon.png'),
});
